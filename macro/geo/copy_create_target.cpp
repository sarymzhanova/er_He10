...
//Change output
  TString outGeoFilenameRoot = erPath + "/geometry/target.test_vacuum.geo.root";
  TString outGeoFilenameGdml = erPath + "/geometry/target.test_vacuum.gdml";
...
//  Double_t shellZThickness = 0.00168; // cm default=[0.25]
  ...
  // Volumes
  TGeoVolume* target3HVol = new TGeoVolume("target3HVol", target3HShape, pvacuum);
  TGeoVolume* targetShellVol = new TGeoVolume("targetShellVol", targetShellShape, pvacuum);
