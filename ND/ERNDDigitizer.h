...
protected:
  ERNDDigi* AddDigi(Int_t stilbenNb, Float_t edep, Float_t edep_n1, Float_t edep_n2, Float_t edep_mis, Int_t parentTrackID, Float_t lightYield, Float_t time, Float_t time_n1,Float_t time_n2,Float_t time_mis, Float_t neutronProb, Float_t x_in, Float_t y_in, Float_t z_in);
